##Jacob Swales, 2019
##Creative Commons License: Use at will, just keep my name in source code
...
def switch_commands(self):
    ...
    if place_flag == False:
        ...
        flag_shower.configure(text='True',fg='green')
        ...
        flag_shower.configure(text='False',fg='red')
...
def build_GUI(x_length,y_length):
    ...
    for c in range(y_length):
        ...
        buttons.append(temp)
    flag_label = tk.Label(text='Is flag mode on?',bg='light grey',padx=5)
    flag_label.grid(column=0,row=(y_length+1),columnspan=6)
    global flag_shower
    flag_shower = tk.Label(text='False',fg='red',bg='light grey',padx=5)
    flag_shower.grid(column=6,row=(y_length+1),columnspan=2)
